game:GetService("StarterGui"):SetCore("SendNotification",{["Title"] = "✅AUTO-FARM SLAP✅",["Text"] = "Thx for using this script ❤️ (funpay.com/users/6412543)",["Duration"] = 30})
game:GetService("StarterGui"):SetCore("SendNotification",{["Title"] = "❓STOP AUTO-FARM❓",["Text"] = "To stop press <<R>> (funpay.com/users/6412543)",["Duration"] = 999,["Button1"] = "Thx."})
...
game:GetService("StarterGui"):SetCore("SendNotification",{["Title"] = "⛔STOP AUTO-FARM⛔",["Text"] = "⛔Script stopped⛔ (funpay.com/users/6412543)",["Duration"] = 10})      
