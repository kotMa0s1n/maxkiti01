...
local Window = Library.CreateLib("maxkikiti01 multi-hub", "Serpent")
...
Section:NewButton("Phantom Forces (OP)", "Ceri (op ass pf script)", function()
    loadstring(game:HttpGet("https://ducksite.xyz/ceri/main.lua"))()
end)
Section:NewButton("Arsenal (BEEEEEEEEEST)", "Real Best", function()
    loadstring(game:HttpGet('https://pastebin.com/raw/8ysy7ENG',true))()
end)
Section:NewButton("DaHood", "RAYX", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/SpaceYes/Lua/Main/DaHood.Lua'))()
end)
Section:NewButton("Bad Business", "Evo V2", function()
...
Section:NewButton("Sonic Speed Simulator", "MasterHub", function()
...
Section:NewButton("Break In 2", "...", function()
    getgenv().ignoreGameCheck = false;
    loadstring(game:HttpGet("https://luau.tech/build"))()
end)
Section:NewButton("1. Murder Mystery 2", "ESP (no gun)", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Ihaveash0rtnamefordiscord/Releases/main/MurderMystery2HighlightESP"))(' Watermelon ?')
end)
Section:NewButton("2. Murder Mystery 2", "And *Flee the Facility*", function()
    loadstring(game:HttpGet("https://pastebin.com/raw/S8fvVGxD"))()
end)
Section:NewButton("3. Murder Mystery 2", "vertex", function()
